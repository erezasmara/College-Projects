    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resetText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ProfileActivity.this,RestPasswordActivity.class));
            }
        });
...
//Success
        ...
        } else if (user != null && displayName != null ){ //only display name
            UserProfileChangeRequest profile = new UserProfileChangeRequest.Builder()
                    .setDisplayName(displayName)
                    .build();
...
//    Up load information Image , picture
